...
On voit ainsi que par rapport à l'ensemble, dernière colonne de droite, la mention "passable" est surreprésentée parmi les redoublements, alors que les mentions "assez bien" à "très bien" sont surreprésentées parmi les passages directs en L2. La situation des réorientés en DUT apparaît intermédiaire : seule la mention "assez bien" est surreprésentée par rapport à l'ensemble des néobacheliers inscrits en licence.
