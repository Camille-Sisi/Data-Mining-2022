...
nom_fonction <- function(data, var1, var2) {
  ...
  return(tab)  # Optionnel, mais la plupart du temps utilisé (!), 
...
<div align="justify"> 
Vous trouverez également des informations utiles <a href="https://thinkr.fr/comment-creer-des-fonctions-dans-le-tidyverse-avec-la-tidyeval-et-le-stash-stash/" target="_blank">ici</a>.  
...
Essayez donc de créer un fonction `tableau()`, reprenant le code de la section précédente et ci-dessous pour information : 
```{r eval=FALSE}
PassageL1L2 %>% 
