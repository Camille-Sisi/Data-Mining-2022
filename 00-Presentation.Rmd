...
Ce document est la version 2022 du cours de Data Mining dispensé aux étudiants de deuxième année de l’option Data du master MECI parcours PISE et CCESE. Ce cours est partagé avec Claude Grasland, dont vous trouverez la partie de cours à l’adresse suivante : https://cgrasland.gitpages.huma-num.fr/datamining2022/index.html.

Ce document est régulièrement corrigé et mis à jour. La version de référence est disponible en ligne à l’adresse suivante :

- [https://github.com/Camille-Sisi/Data-Mining-2022](https://github.com/Camille-Sisi/Data-Mining-2022).
...
Ce document est généré par l'extension [bookdown](https://bookdown.org/) de [Yihui Xie](https://yihui.name/) et se base sur le template proposé par Julien Barnier pour introduire des exercices interactifs dans son cours de tidyverse.
