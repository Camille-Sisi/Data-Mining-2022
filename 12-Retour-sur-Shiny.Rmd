...
Enifn, on va utiliser la fonction `observeEvent()` avec une condition `if ... else ...` dans la même logique pour que le graphique soit modifiée selon le niveau d'analyse sur lequel on se situe.    
...
Pour que cela soit encore plus pertinent, on va également modifier maintenant le tableau général des indicateurs pour qu'il soit lui aussi réactif selon le niveau d'analyse choisi.  On va utiliser la même fonction `observeEvent()` et une condition `if ... else ...`.
