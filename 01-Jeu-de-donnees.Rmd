...
Il faudra donc faire attention dans l'interprétation des traitements statistiques que l'on pourra faire de ces données. L'élément important est la "base", c'est-à-dire le dénominateur des indicateurs qui nous sont donnés, c'est cette variable qu'il faudra identifier et qui nous permettra de connaître les effectifs globaux des bacheliers inscrits selon l'année et ensuite par catégories.  
